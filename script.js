...
const caseData = {
  ...
  demolition: {
    type: "Лендинг · демонтаж · CRM",
    title: "Демонтаж под ключ",
    summary:
      "Публичный сайт услуг демонтажа в Москве и Московской области: посетитель быстро понимает состав работ, от чего зависит цена и как получить бесплатную оценку объекта.",
    metrics: [
      ["Desktop + mobile", "адаптивная версия"],
      ["2 продукта", "лендинг и CRM-прототип"],
    ],
    list: [
      "Оффер, услуги и факторы расчёта стоимости",
      "Портфолио объектов и пошаговый процесс работ",
      "Формы заявки с отдельным согласием на обработку данных",
      "Контакты, юридические страницы и настройки cookies",
    ],
    visual: "image",
    image: "assets/demolition-site-cover.jpg",
    alt: "Сайт услуг демонтажа в Москве и Московской области",
    projectUrl: "https://wm669vjvr2-ui.github.io/naumenko-demolition/",
    projectLabel: "Открыть сайт демонтажа",
  },
  "ai-video": {
